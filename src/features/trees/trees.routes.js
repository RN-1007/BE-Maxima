...
// Petani & Admin: POST /api/trees - Add new tree & auto generate fertilization schedule (FR-1)
router.post('/', authenticateToken, requireRole(ROLES.FARMER, ROLES.ADMIN), treesController.addTree);
